...
const Projects = () =>
    <div className="myProjects">
        ...
        <div className="itemGrid">
            <a href="https://sfmusic.herokuapp.com" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://sfrecords.herokuapp.com" target="_blank" rel="noopener noreferrer">
                <div className="projectItem">
                    <div className="projectItemHeader">
            ...
            <a href="https://github.com/blealf/ProjectSearch" target="_blank" rel="noopener noreferrer">
                <div className="projectItem">
                    <div className="projectItemHeader">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer">
                <div className="projectItem">
                    ...
                    <div className="seeMore">
                        <a href="#" target="_blank" rel="noopener noreferrer"> <i class="fas fa-link"></i> See More </a>
                    </div>
                </div>
            </a>
        </div>
